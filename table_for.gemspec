spec = Gem::Specification.new do |s|
  ...
  s.files             = ["README.rdoc", "Rakefile", "Changelog", "Gemfile", "lib/table_for.rb", "spec/table_for_spec.rb", "spec/table_for_spec.rb"]
  s.test_files        = ["spec/table_for_spec.rb", "spec/table_for_spec.rb"]
  s.require_path      = "lib"
